          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: AppTheme.safeGreen.withAlpha(31),
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 44,
            decoration: BoxDecoration(
              color: center.color.withAlpha(31),
          ...
          Column(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: center.color.withAlpha(38),
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
                    color: center.color.withAlpha(89),
                    width: 1,
                  ),
                ),
                child: Row(
              ...
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                decoration: BoxDecoration(
                  color: AppTheme.safeGreen.withAlpha(26),
                  borderRadius: BorderRadius.circular(6),
                ),
                child: Row(
                  children: [
